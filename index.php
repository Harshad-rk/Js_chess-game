...
<html lang="en">
	...
	<!--	<div id="CurrentFenDiv">
		...
		<div id="SaveLoadOutput" style="display:none">		
			...
			<br/>-->
			<input type="submit" class="btn btn-default" id="multiplayer_submit" 
			onclick="parent.location='chMult/pages/UserLogin.php'" 
			value="Multiplayer game">				
		</div>
		
		<span id="GameStatus"></span>
		<button type="button" class="btn btn-default" id="NewGameButton">New Game</button><br/>
